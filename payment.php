	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="panel panel-primary">
				...
				<h1>Thank You</h1>
				<hr>
				<p>Hello <?php echo $_SESSION["name"]; ?> , your payment process is successfully completed and your transaction ID is xxxx-xxxx-xxx-xx<br> You can continue your shopping<br></p>
